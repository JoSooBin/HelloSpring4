...
import JSB.data.service.MemberService03;
...
public class HelloSpring4DataApp03 {
    //mybiatis를 이용한 프로젝트
    //spring JDBC API를 좀 더 편하게 사용하기 위해 개발된 퍼시스턴스 계층 프레임워크
