...
public class MemberService {
    ...
    public String readMember() {
        ...
        List<MemberVO> mvos = mado.selectMember();
        for(MemberVO m : mvos){
    ...
    public String readOneMember() {
        ...
        MemberVO mvo = mado.selectOneMember("spring4");
